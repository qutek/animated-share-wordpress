	...
	<div id="tabs" class="tabs">
		...
		<div class="content">
			<section id="section-1">
				<div class="mediabox">
					<img src="<?php echo plugins_url('assets', __FILE__); ?>/img/01.png" alt="img01" />
				...
				<div class="mediabox">
					<img src="<?php echo plugins_url('assets', __FILE__); ?>/img/02.png" alt="img02" />
				...
				<div class="mediabox">
					<img src="<?php echo plugins_url('assets', __FILE__); ?>/img/03.png" alt="img03" />
			...
			<section id="section-2">
				<div class="mediabox">
					<img src="<?php echo plugins_url('assets', __FILE__); ?>/img/04.png" alt="img04" />
				...
				<div class="mediabox">
					<img src="<?php echo plugins_url('assets', __FILE__); ?>/img/05.png" alt="img05" />
				...
				<div class="mediabox">
					<img src="<?php echo plugins_url('assets', __FILE__); ?>/img/06.png" alt="img06" />
