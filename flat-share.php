...
Plugin URI: http://plugins.astahdziq.in/FlatShare
...
if ( file_exists( plugin_dir_path( __FILE__ ) .'includes/class.FlatShare-options.php' ) ) {
    require_once( plugin_dir_path( __FILE__ ) .'includes/class.FlatShare-options.php' );
}

if( is_admin() )
$FlatShare = new FlatShareSettingsPage();
...
//     // wp_register_script('animated_share_style', plugins_url('css/flat-share.css', __FILE__));
//     wp_register_style( 'animated_share_style', plugins_url('css/flat-share.css', __FILE__) );
